...
Excited to collaborate on Data Science projects, Power BI dashboards, ML models, and impactful analytics solutions.
...
- 🧪 [Blinkit Sales Analysis Dashboard](https://github.com/yourusername/blinkit-sales-dashboard)
- 👤 [Sales by Salesperson Dashboard](https://github.com/yourusername/salesperson-dashboard)
- ⚙️ [Server Health Automation with Python + MS Copilot](https://github.com/yourusername/server-health-automation)
